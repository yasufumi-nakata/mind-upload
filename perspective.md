...
page_highlights:
  ...
  - "The page now separates local connectomics, human structural scaffold evidence, synaptic-density PET, receptor / transporter atlas priors, occupancy PET target-engagement routes, challenge-linked displacement / release PET routes, biochemical similarity scaffolds, energetic-balance / rate imaging, quantity-defined ionic / thermal / myelin routes, BBB water-exchange and tracer-specific transport routes, target-defined astrocyte PET, clearance support-state proxies, and hemodynamic transfer audits instead of collapsing them into one 'multimodal' advance."
...
<tr>
<td><strong>Dynamic deuterium metabolite / rate imaging</strong><br><a href="https://doi.org/10.1093/pnasnexus/pgaf072" target="_blank">Li et al. (2025)</a></td>
<td>Whole-brain glucose-transport and metabolic-rate maps from a specialized dynamic DMRSI route with kinetic modeling.</td>
<td>Equivalence to <sup>31</sup>P energetic balance, exchange-flux, or NAD routes, direct mitochondrial-controller identity, and same-subject hidden-state closure.</td>
