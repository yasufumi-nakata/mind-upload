...
<td>Route-free absolute metabolite distributions, equivalence to <sup>31</sup>P energetic balance, exchange-flux, or NAD routes, direct mitochondrial-controller identity, and same-subject hidden-state closure.</td>
...
<td>Density, similarity, resting balance, exchange flux, static NAD content, task-locked local dynamics, absolute metabolite distributions, kinetic-rate maps, ionic partition, temperature, water exchange, tracer-specific transport, target-defined binding, mobility, and model-based efflux are different inferential objects. Row count is therefore not yet a validated latent coordinate.</td>
