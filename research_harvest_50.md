...
<td>Whether intrinsic-excitability allocation, AIS / channel-state plasticity, homeostatic set-point / recovery control, human local clinical-unit allocation, sleep-dependent homeostasis / plasticity proxy, state-gated perturbation proxy, transcriptional stabilization, post-transcriptional RNA control, phospho-signaling, local proteostasis / tag-capture balance, cargo-routing state, ionic / chloride regulation, bioenergetic / mitochondrial support, neurovascular-unit / BBB / pericyte support, clearance / immune support, neuromodulatory class split, astrocyte multiday trace, myelin/metabolic support, and active maintenance have been dropped from the picture.</td>
