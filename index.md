...
known_points:
  ...
  - "Current primary literature also requires transcription / chromatin to be read as a distinct hidden-state family: cell-type atlases, one-shot DEG lists, and spatial transcriptomic signatures still do not by themselves fix allocation eligibility, time-resolved response programs, persistent stabilization cascades, or locus-specific causal editability."
...
<p>
This site now blocks that shortcut too. <a href="https://doi.org/10.1038/47029" target="_blank">Galarreta &amp; Hestrin (1999)</a> constrains <strong>fast-spiking interneuron gap-junction networks</strong>, <a href="https://doi.org/10.1038/nn.2727" target="_blank">Anastassiou et al. (2011)</a> constrains <strong>endogenous field-driven spike-timing bias</strong>, <a href="https://doi.org/10.1016/j.neuron.2023.08.005" target="_blank">Burman et al. (2023)</a> constrains <strong>state-dependent inhibitory driving-force regime in active cortex</strong>, <a href="https://doi.org/10.1073/pnas.2313042121" target="_blank">Yang et al. (2024)</a> constrains <strong>activity-dependent electrical-synapse deployment that fuels persistent oscillations</strong>, and <a href="https://doi.org/10.1038/s41467-024-53074-y" target="_blank">Selfe et al. (2024)</a> constrains <strong>local inhibitory driving force</strong> but only with a specialized local optical route. Human perturbation evidence such as <a href="https://doi.org/10.1111/ejn.70401" target="_blank">Feld et al. (2026)</a> is useful as a clue that electrical coupling can matter for spindle-to-slow-oscillation coordination, but it is still not a direct whole-brain readout of local electrical state. Therefore, a chemical connectome, nominal inhibitory edge list, or human sleep-memory perturbation result is not read here as ground truth of local electrical coupling or electrotonic regime. The shortest route is <a href="wbe_101.html#state-completeness">WBE 101: hidden state at the entry point</a> plus <a href="verification.html">Verification</a> and <a href="wiki/connectome-is-not-enough.html#electrical-state-route-card">Wiki: electrical-state route card</a>.
</p>
</div>
