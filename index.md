...
page_highlights:
  ...
  - "Clearance / immune evidence is not one class: drainage anatomy, macroscopic CSF oscillation, microglia-related synaptic control, parenchyma-CSF water exchange, intrathecal tracer retention / CSF-to-blood clearance, human CSF-mobility MRI, and model-based biomarker-efflux routes are kept separate."
...
known_points:
  ...
  - "Current primary literature also treats clearance / immune support as a measurable multiday support-state, but current human macroscopic CSF-oscillation, parenchyma-CSF water-exchange, intrathecal tracer / CSF-to-blood-clearance, CSF-mobility, and model-based biomarker-efflux routes still stop at macro support-state proxy rather than local immune-controller readout."
