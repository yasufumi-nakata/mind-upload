...
<p>
This site now blocks that shortcut too. <a href="https://doi.org/10.1126/science.adg9982" target="_blank">Santoni et al. (2024)</a> constrains <strong>chromatin-linked allocation eligibility before memory-trace formation</strong>, <a href="https://doi.org/10.1038/s41467-025-63029-6" target="_blank">Traunmüller et al. (2025)</a> constrains a <strong>time-resolved, region- and cell-type-specific chromatin / gene-expression response after novel-environment exposure</strong>, <a href="https://doi.org/10.1038/s41586-025-09774-6" target="_blank">Terceros et al. (2026)</a> constrains a <strong>thalamocortical transcriptional cascade with distinct roles across the memory-stabilization window</strong>, and <a href="https://doi.org/10.1038/s41588-025-02368-y" target="_blank">Coda et al. (2025)</a> constrains <strong>locus-specific epigenetic editing of memory expression in defined engram cells</strong>. <a href="https://doi.org/10.1038/s41586-023-07011-6" target="_blank">Sun et al. (2024)</a>, <a href="https://doi.org/10.1038/s41586-025-08988-y" target="_blank">Mukamel &amp; Yu (2025)</a>, and <a href="https://doi.org/10.1038/s41586-025-08989-x" target="_blank">Sun et al. (2025)</a> further show that memory-related transcriptomic signatures remain sensitive to animal-level independence and analysis choices. Therefore, a cell-type atlas, one-shot DEG list, or spatial transcriptomic cluster is not read here as if it already fixed the current plasticity-competent program or the memory-stabilization controller. The shortest route is <a href="wbe_101.html#state-completeness">WBE 101: hidden state at the entry point</a> plus <a href="wiki/homeostatic-plasticity-and-maintenance-state.html#transcription-route-card">Wiki: transcription / chromatin route card</a>.
</p>
</div>
<div class="note-box">
...
<p>
This site now blocks that shortcut too. A result can be <strong>same-subject</strong> or <strong>same-brain</strong> and still fail to be one state sample if the bridge crosses from live measurement to later fixation / ex vivo follow-up or from one day / regime to another. <a href="https://doi.org/10.1016/j.crmeth.2023.100520" target="_blank">Lu et al. (2023)</a> and <a href="https://doi.org/10.1038/s41586-025-08790-w" target="_blank">MICrONS Consortium et al. (2025)</a> make that narrower reading necessary. Therefore, same-subject wording is not enough here unless the paper also discloses a <a href="verification.html#state-continuity-bridge-card">State-Continuity Bridge Card</a> that names acquisition order, elapsed time, regime continuity, coordinate transfer, and residual drift ceiling. The shortest route is <a href="wbe_101.html#human-observability-ladder">WBE 101: human observability ladder</a>, <a href="verification.html#state-continuity-bridge-card">Verification: State-Continuity Bridge Card</a>, and <a href="wiki/state-continuity-bridge.html">Wiki: State-Continuity Bridge</a>.
</p>
</div>
