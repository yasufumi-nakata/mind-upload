...
page_highlights:
  ...
  - "Bioenergetic evidence is not one class: presynaptic ATP-demand support, dendritic mitochondrial positioning / fission, synaptic ATP-synthase nano-organization, mitochondrial Ca2+-efflux tuning, human 31P-MRS energetic-balance routes, and deuterium metabolite / rate imaging are kept separate."
  - "Spectroscopy-derived human routes are not one class: five-metabolite 1H-MRSI similarity scaffolds, 31P-MRS energetic-balance routes, and deuterium metabolite / kinetic-rate imaging should not be compressed into one row."
...
<p>
This site now blocks that shortcut too. <a href="https://doi.org/10.1038/s41467-025-66124-w" target="_blank">Lucchetti et al. (2025)</a> defined a <strong>five-metabolite gray-matter parcel-similarity graph</strong>, <a href="https://doi.org/10.1002/nbm.3384" target="_blank">Ren et al. (2015)</a> quantified <strong>ATP synthesis, phosphorus metabolites, and intra-/extracellular pH</strong> with <sup>31</sup>P-MRS in <strong>12 resting human brains</strong>, <a href="https://doi.org/10.1093/pnasnexus/pgaf072" target="_blank">Li et al. (2025)</a> used <strong>7 T dynamic DMRSI plus blood-input and kinetic modeling</strong> to map <strong>CMR<sub>Glc</sub>, CMR<sub>Lac</sub>, V<sub>TCA</sub>, and T<sub>max</sub></strong> in <strong>five healthy participants</strong>, <a href="https://doi.org/10.1002/mrm.70308" target="_blank">Karkouri et al. (2026)</a> produced <strong>absolute HDO / Glc / Glx / Lac maps and rate maps</strong> at <strong>7 T</strong>, and <a href="https://doi.org/10.1109/TBME.2025.3572448" target="_blank">Guo et al. (2025)</a> showed that <strong>high-resolution 1H-MRSI metabolite distributions</strong> are yet another object with its own acquisition / reconstruction burden. Therefore, one spectroscopy paper is not read here as if <strong>biochemical similarity</strong>, <strong>energetic balance</strong>, <strong>absolute metabolite distribution</strong>, and <strong>kinetic rate imaging</strong> were one solved route. The shortest route is <a href="wbe_101.html#human-observability-ladder">WBE 101: human observability ladder</a>, <a href="verification.html#observability-budget">Verification: Observability Budget</a>, and <a href="wiki/measurement-stack-and-claim-ceiling.html#human-maintenance-proxy-ladder">Wiki: human maintenance-state ladder</a>.
</p>
</div>
<div class="note-box">
...
<td>Kinetic macro rates are not the same quantity as density, 1H-MRSI similarity, 31P energetic balance, or myelin-sensitive contrast.</td>
</tr>
<tr>
