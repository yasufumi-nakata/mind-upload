...
description: A beginner technical overview of mind uploading and WBE that separates broad ambition from what current evidence can actually support.
article_type: Wiki
...
accuracy_note: This page stays on the technology and natural-science side. Unresolved issues are kept unresolved rather than softened with vague language.
page_highlights:
...
- An effective-connectivity graph is still a model-conditioned causal hypothesis unless observed-subsystem closure / latent-confound audit, node-definition policy, sampling / transformation sensitivity, validation, and reliability window are disclosed.
...
- "Transcription / chromatin state is not the whole molecular maintenance layer either: post-transcriptional RNA-state, phospho-signaling / second-messenger state, local proteostasis / synaptic-tagging state, and cargo-transport / cytoskeletal trafficking state remain separate hidden-state families with different observables, compartments, timescales, and human ceilings."
...
- label: 'Wiki: How to read claims and evidence'
  ...
  description: Translates the big picture into everyday claim-reading rules.
- label: 'Wiki: Why wiring diagrams alone are not enough'
  url: /wiki/connectome-is-not-enough.html
  description: Explains what current structure-only routes still leave unresolved.
...
- label: 'Wiki: Homeostatic plasticity and maintenance state'
  ...
  description: Organizes the slow hidden-state families that remain outside structure-only routes.
- label: 'Wiki: Basics of verification infrastructure'
  url: /wiki/verification-basics.html
  description: Shows why route cards, audits, and registries come before strong claims.
recommended_pages:
...
<h2 class="section-title">Three words to align first</h2>
...
<h2 class="section-title">Why this site does not say "done" quickly</h2>
<p>
...
<p>
The point is not to dismiss progress. The point is to read each result at the right level. On this site, the fastest route for that is now <a href="claims-and-evidence.html">Wiki: how to read claims and evidence</a>, followed by the specific route-card pages for measurement stack, connectomes, effective connectivity, thermodynamic claims, maintenance-state families, and closed loops.
</p>
</div>
</section>

<section class="section" id="site-role">
<h2 class="section-title">What this site is trying to build</h2>
<p>
...
<td><a href="verification-basics.html">Basics of verification infrastructure</a></td>
