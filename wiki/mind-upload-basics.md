...
- Same-brain functional connectomics and MICrONS-side digital-twin language now stay behind a beginner ceiling of sequential local scaffold plus stimulus-conditioned predictor, not a solved local twin.
...
- Same-brain functional connectomics can strengthen local structure-function correspondence while still leaving predicted-versus-direct labels, current synaptic-state, and dynamical identifiability unresolved.
