...
- On the human side, quantity type is part of the claim: five-metabolite 1H-MRSI similarity, 31P-MRS energetic balance, 31P NAD-content mapping, 31P functional NAD-dynamics, deuterium metabolite-mapping / absolute-quantification routes, deuterium kinetic-rate imaging, myelin-water, MT-family, bilayer-sensitive MRI, BBB water-exchange MRI, tracer-specific BBB PET, MAO-B PET, and I2BS PET are not interchangeable routes.
