---
layout: default
title: "Wiki: U13-2 brain-minus-prior route packet"
description: "Why U13-2 stays first in the current public six, why D10 3M-CPSEED is the primary EEG anchor, and what the first artifact can honestly close."
article_type: Wiki
...
page_intro: "This page fixes the current public route for U13-2 at the level of one question, one primary dataset anchor, one bounded first artifact, and one funding bridge."
accuracy_note: "This page does not claim preserved mechanism, preserved identity, or successful mind preservation. It only records what the present EEG route can honestly close first."
wiki_links:
...
| `D03 Multimodal Fusion EEG + Eye-Tracking` (`10.21227/6106-6120`, immediate) | It is useful for transfer and branch-point reading because it keeps EEG plus gaze in one immediately accessible package. | It is not speech-first, and the current metadata is thinner than `D10`, so it stays a bounded support anchor rather than the first speech-side anchor. |
