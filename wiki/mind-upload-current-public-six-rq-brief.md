...
- An actual-pull recheck at `2026-04-01 22:02 JST` after `mind-upload@84e5337`, `EEG-DATA@bbb8d6c63d7`, and `auto-research-funds@5ff33413e` still leaves the public batch and the solve-first order unchanged.
...
|---|---|---|---|
| `U13-5` | `D10 3M-CPSEED`, `ZuCo 2.0`, and `spoken + imagined robot-speech EEG` | `D10` keeps the speech-side control family public-open, `ZuCo 2.0` restores a public EEG+ET paired-stream family, and the robot-speech route keeps overt/imagination stress tests inspectable without a gated page. | None of them exposes a clean recall-labeled branch point on the public route, so they remain backup-only until recall validity is fixed. |
