---
layout: default
title: 'Mind-upload 現在のパブリック 6: EEG ルートの概要'
description: 現在、制限付き EEG 対応ワーク パッケージに変換されている 6 つのマインド アップロードの研究質問に対するパブリック セーフな 1 行ずつの概要。
article_type: ウィキ
subtitle: 解決済みのクレームの最新情報ではなく、狭いルートの概要
author: マインドアップロード研究プロジェクト
last_updated: '2026-04-04'
note: 現在の公立6名
audience: 主張を深読みせずに、一度に 1 つずつ質問する現在の EEG ルートを希望する読者
reading_time: 8～12分
page_intro: このページは、1 つの RQ、1 つの境界アンカー、1 つの最初のアーティファクト、および 1 つのファンディング センテンスのレベルで、現在の公開されている 6 つの質問のルートを修正します。
wiki_links:
- label: 'Wiki: RQ 可解決性ブリッジ'
  url: /wiki/mind-upload-rq-solvability-bridge.html
  description: EEG が現在クローズできるもの、まだ外部のサポートが必要なもの、そしてどの資金レーンがまだ適合しているのかを 1 ページにまとめました。
- label: 'Wiki: RQ ごとの詳細な資料'
  url: /wiki/mind-upload-rq60-rq-by-rq-deep-dossiers.html
  description: 現在のパブリック 6 とより広い 60RQ マップの長期間にわたる作業書類。
- label: 'Wiki: 助成金とデータセットのプレイブック'
  url: /wiki/mind-upload-eeg-rq60-grant-dataset-playbook.html
  description: 各 RQ から現在の制限付き資金レーンおよび EEG アンカーまでのルート。
- label: 'Wiki: U13-2 ルート パケット'
  url: /wiki/u13-2-brain-minus-prior-route.html
  description: なぜ D10 が U13-2 の 1 位に留まるのか、なぜ他のスピーチ候補が 2 番目に留まるのか、そして最初のアーティファクトが正直に解決できるものは何なのか。
- label: 'Wiki: U13-5 ルート パケット'
  url: /wiki/u13-5-perception-to-recall-route.html
  description: D03 が U13-5 の意図されたゲート サポート アンカーであり続ける理由、サポート アンカーが二次的なままである理由、およびトランスファー ギャップ アーティファクトが正直に埋めることができるもの。
- label: 'Wiki: U0-2 ルート パケット'
  url: /wiki/u0-2-temporal-validity-route.html
  description: D02 が U0-2 の意図されたゲート サポート アンカーであり続ける理由、サポート アンカーが二次的なままである理由、タイミング フロア アーティファクトが正直に閉じることができるもの。
- label: 'Wiki: U0-3 ルート パケット'
  url: /wiki/u0-3-threshold-stability-route.html
  description: D02 が U0-3 の意図されたゲート サポート アンカーであり続ける理由、サポート アンカーが二次的なままである理由、およびしきい値ガバナンス アーティファクトが正直に閉じることができるもの。
- label: 'Wiki: U14-4 ルート パケット'
  url: /wiki/u14-4-card-contract-route.html
  description: D01 が U14-4 の意図されたゲート サポート アンカーであり続ける理由、よりリッチな再実行ベンチマークが二次的なままである理由、カード契約アーティファクトが正直に解決できるもの。
- label: 'Wiki: U14-2 ルート パケット'
  url: /wiki/u14-2-fixed-split-route.html
  description: D01 が U14-2 の意図されたゲート サポート アンカーであり続ける理由、よりリッチな再実行ベンチマークが二次的なままである理由、固定分割アーティファクトが正直に解決できるもの。
- label: 'Wiki: U7-2 ルート パケット'
  url: /wiki/u7-2-timing-metric-route.html
  description: 現在のパブリック 6 を変更せずに、同じ D11 同期ファミリーを読み取り可能に保つ隣接するタイミング メトリック パケット。
recommended_pages:
- label: 発行ページ
  url: /issue.html
- label: ディープフォーカスノート
...
- 行固有のアンカー選択の根拠が必要な場合は、[U13-2 ルート パケット](/wiki/u13-2-brain-minus-prior-route.html) を読んでください。
...
- 行固有のアンカー選択の根拠が必要な場合は、[U13-5 ルート パケット](/wiki/u13-5-perception-to-recall-route.html) を読んでください。
...
- 行固有のアンカー選択の根拠が必要な場合は、[U0-2 ルート パケット](/wiki/u0-2-temporal-validity-route.html) を読んでください。
...
- 行固有のアンカー選択の根拠が必要な場合は、[U0-3 ルート パケット](/wiki/u0-3-threshold-stability-route.html) を読んでください。
...
- 行固有のアンカー選択の根拠が必要な場合は、[U14-4 ルート パケット](/wiki/u14-4-card-contract-route.html) を読んでください。
...
- 行固有のアンカー選択の根拠が必要な場合は、[U14-2 ルート パケット](/wiki/u14-2-fixed-split-route.html) を読んでください。
