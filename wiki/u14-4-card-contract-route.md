---
layout: default
title: "Wiki: U14-4 card-contract route packet"
description: "Why U14-4 stays fifth in the current public six, why D01 remains the primary bounded EEG anchor, and what the first artifact can honestly close."
article_type: Wiki
subtitle: "A row-specific packet for the disclosure-first reproducibility row"
author: Mind Uploading Research Project
last_updated: "2026-03-30"
note: "U14-4 route packet"
audience: "Readers who want the dataset-choice rationale and the honest claim ceiling for the current card-integration row"
reading_time: "8-12 minutes"
page_intro: "This page fixes the current public route for U14-4 at the level of one question, one primary dataset anchor, one bounded first artifact, and one funding bridge."
accuracy_note: "This page does not claim field-wide reproducibility, deployment readiness, or standards adoption. It only records what the present EEG route can honestly close first."
wiki_links:
...
This page does not change the current public six-question batch. It makes only the fifth active row more explicit, so readers can see why `U14-4` still stays before `U14-2`, why `D01 Acquisition delay of wireless EEG` remains the present bounded entry point, and what the next public-safe artifact can honestly close.

## What was rechecked for this row

- `D01 Acquisition delay of wireless EEG` still gives an immediate DOI route for a latency-first wireless EEG measurement package, which is enough to keep the disclosure route concrete and narrow.
...
|---|---|---|
| `D01 Acquisition delay of wireless EEG` (`10.21227/dv1p-vq18`, immediate) | It keeps a latency-first measurement route concrete enough to force real Model Card and Dataset Card fields into a rerun checklist. | It stays the primary anchor in this run. |
...
| `Secom General Research Grant` (`watch only`) | `Latency-aware disclosure and rerun-contract audit for EEG verification artifacts` | The route stays plausible only as an urgency-watch submission and should not replace the main planning lane. |
...
- The main change is that `U14-4` now has a row-specific public packet that records the anchor-choice rationale instead of leaving it implicit.
