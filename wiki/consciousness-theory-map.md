...
description: This is a technical note that organizes IIT, GNWT, FEP, PCI, resting-state
  complexity, and manifold geometry by dividing them into theory, perturbation benchmark,
  proxy, and auxiliary analysis.
article_type: Wiki
subtitle: Before the theory name, separate the prediction family and benchmark layer.
author: Mind Uploading Research Project
last_updated: '2026-03-15'
note: Technical / natural science only
audience: People who are easily stopped due to role differences between IIT, GNWT,
  FEP, PCI, and criticality
reading_time: 12-18 minutes
page_intro: This page is a supplementary page that organizes the theories of consciousness
  and consciousness indicators that repeatedly appear in Mind-Upload from the perspective
  of technology and natural science. Rather than deciding which is true, we first
  separate what is a prediction family, what is a perturbation benchmark, and what
  is a spontaneous proxy or auxiliary analysis.
accuracy_note: The usage shown here is not the conclusion that each paper declares
  as is. The primary literature as of 2026-03 supports this relatively strongly, and
  this site is an operational arrangement based on the remaining unconfirmed parts.
page_highlights:
- IIT, GNWT, and FEP are theory families, PCI/PCI-ST is perturbation benchmark, criticality
  is spontaneous proxy, and TDA is auxiliary analysis.
- Ferrante et al. (2025) From now on, the design of preregistered prediction competition
  is more important than the success or failure of a single theory.
- PCI is a strong benchmark candidate, but it is not a universal meter; criticality
  and geometry are auxiliary tracks with external calibration.
known_points:
- If you mix theory names and measurement indicators, you will not know what is a
  hypothesis and what is a verification indicator.
- If we remove the no-report/task-relevance/criterion placement controls, the construct
  validity of the theoretical markers collapses.
- Perturbation indicators and spontaneous indicators are often related, but they can
  be dissociated even within the same cohort, so they cannot be treated as a substitution
  relationship.
- Manifold/topology analysis is promising, but is sensitive to sampling and preprocessing
  and is not a stand-alone pass/fail indicator.
unknown_points:
- It is unclear which theory family will ultimately be close to the sufficient condition
  for WBE.
- It is also unclear which perturbation benchmark most consistently straddles altered
  states and disorders of consciousness.
- It is unresolved under what conditions spontaneous proxy and geometry descriptor
  can be promoted to major indicators.
wiki_links:
- label: 'Wiki: Counterfactuals/Interventions/Perturbations'
  url: /wiki/counterfactual-and-perturbation-verification.html
  description: We will organize the conditions for dropping the theoretical marker
    into the intervention benchmark.
- label: 'Wiki: From observation to estimation'
  url: /wiki/observation-to-estimation.html
  description: This page is to avoid confusing observational fit and causal identification.
- label: 'Wiki: How to read the literature and evidence page'
  url: /wiki/literature-and-evidence-reading.html
  description: We will clarify the role differences between theoretical papers and
...
<h2 class="section-title">Boundaries cut by primary literature</h2>
<table class="data-table">
<thead>
<tr>
<th>Issues</th>
...
<h2 class="section-title">How to use with Mind-Upload</h2>
...
<h4>Pin this page</h4>
<ul>
<li>Distinction between theory family and benchmark layer</li>
<li>Difference in role between PCI and spontaneous proxy</li>
<li>How to handle geometry / topology</li>
</ul>
</div>
<div class="sidebar-box">
