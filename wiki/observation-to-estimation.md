...
page_highlights:
  ...
  - "局在妥当化、network 妥当化、perturbation 妥当化は別ラダーで、1 つの positive result で代用しません。"
...
<section class="section" id="connectivity-validation-ladder">
<h2 class="section-title">2026-03 文献監査：局在妥当化と network 妥当化は別ラダーです</h2>
<p>
