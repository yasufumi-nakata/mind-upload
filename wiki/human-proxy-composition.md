...
page_highlights:
  - "Human proxy routes differ not only in strength, but in quantity / target / transport type: structural scaffold, density proxy, similarity scaffold, 31P metabolite / pH balance, 31P MT exchange-flux, 31P NAD-content mapping, 31P functional NAD-dynamics, deuterium metabolite-mapping / absolute-quantification route, deuterium kinetic-rate map, quantity-defined myelin route, BBB water-exchange route, tracer-specific BBB transport route, target-defined astrocyte PET, mobility map, and model-based efflux route are different objects."
...
known_points:
  ...
  - "Even when a family label such as `SV2A PET`, `myelin MRI`, or `clearance / immune support` is logged, composition still requires the family-internal comparison type to be named before the bundle role is interpreted."
...
<td>Tracer binding for explicitly named astrocyte-related targets such as MAO-B or I<sub>2</sub>BS, with route-specific quantification and disease-regime dependence.</td>
<td>14 healthy volunteers for first-in-human <sup>18</sup>F-SMBT-1 target validation, 77 volunteers across the AD continuum for pathology-context SMBT-1, 14 healthy male volunteers for first-in-human <sup>11</sup>C-BU99008 pharmacology, and 20-subject multimodal cognitive-impairment imaging.</td>
<td>Tracer target, blockade / competition evidence, quantification route, disease / cohort regime, and cross-target non-equivalence.</td>
<td><strong>Target-defined astrocyte-related proxy</strong>, not one generic astrocyte-state meter and not cell-specific controller identity.</td>
</tr>
<tr>
...
<tr>
<td><strong>Target-defined astrocyte PET routes</strong><br><a href="https://doi.org/10.2967/jnumed.121.263254" target="_blank">Villemagne et al. (2022)</a>; <a href="https://doi.org/10.2967/jnumed.121.263255" target="_blank">Villemagne et al. (2022)</a>; <a href="https://doi.org/10.1007/s12149-025-02083-y" target="_blank">Hiraoka et al. (2025)</a>; <a href="https://doi.org/10.2967/jnumed.118.208009" target="_blank">Tyacke et al. (2018)</a>; <a href="https://doi.org/10.1038/s41380-021-01429-y" target="_blank">Livingston et al. (2022)</a>; <a href="https://doi.org/10.1038/s41380-025-03355-9" target="_blank">Best et al. (2026)</a>; <a href="https://doi.org/10.1007/s00401-024-02712-2" target="_blank">Jaisa-Aad et al. (2024)</a></td>
<td><strong>Target-defined astrocyte-related proxy</strong></td>
<td>Real human PET observability with explicit target binding, but still split by target-validation paper, quantification route, and disease-/covariate regime.</td>
<td>Constrains the named target class, such as MAO-B or I<sub>2</sub>BS, under a bounded tracer and cohort regime.</td>
<td>Generic astrocyte-state language, cross-target equivalence, and cell-specific astrocyte controller identity.</td>
</tr>
<tr>
<td><strong>Sleep-state CSF-oscillation route</strong><br><a href="https://doi.org/10.1126/science.aax5440" target="_blank">Fultz et al. (2019)</a></td>
