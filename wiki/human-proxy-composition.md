...
page_highlights:
  ...
  - "A bundle can be well-typed and still fail operationally if one row is unstable, centre-bound, available only in a narrow complete-case subset, or present mainly in a severity- or site-skewed subset."
...
known_points:
  ...
  - "Even when proxy class, maturity, and calibrator role are logged, composition still needs row-level repeatability, cross-centre transfer, complete-case disclosure, and overlap / missingness disclosure."
