...
description: "Mind-Upload や脳科学のニュースを、主張の強さと必要な証拠で読み分けるための基礎ページです。"
article_type: Wiki
subtitle: "派手な文言を、そのまま強い結論にしないために"
author: Mind Uploading Research Project
last_updated: "2026-03-06"
note: "Reading guide"
audience: "ニュースや研究発表を読み違えたくない人、L0〜L5 を体感でつかみたい人"
reading_time: "10〜15分"
page_intro: "このページは、脳科学や Mind-Upload の話で出てくる強い言い方を、必要な証拠の強さへ引き戻して読むためのガイドです。『すごそう』と『何が証明されたか』を分ける練習をします。"
accuracy_note: "ここでの整理は、主張を弱めるためではなく、過大評価と過小評価の両方を防ぐためのものです。"
page_highlights:
  - "L0〜L5 を、研究の成熟度ではなく主張の強さとして読む練習をします。"
  - "よくあるニュース文言を、実際にはどのレベルの話かへ翻訳します。"
  - "次のレベルへ進むには何が足りないかも一緒に示します。"
known_points:
...
wiki_links:
  - label: "Wiki: WBEの基本"
    ...
    description: "この読み方の前提になる全体像です。"
  - label: "Wiki: 検証基盤の基本"
    url: "/wiki/verification-basics.html"
    description: "なぜ証拠の置き方そのものが大事かを説明します。"
  - label: "Wiki Home"
    url: "/wiki/"
