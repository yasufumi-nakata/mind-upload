...
- An actual-pull recheck at `2026-04-03 00:07 JST` after `mind-upload@dd4611f279c3`, `EEG-DATA@1718489fec75`, and `auto-research-funds@e8feb4479047` still leaves both the current public six and the headline next-watch queue unchanged.
- The newest pulled deltas still tighten support space rather than widen the present bridge: `mind-upload` tightens human-myelin route specificity outside the current six, `EEG-DATA` adds the `AMBER 2.0` audit update while now reporting `30,897` merged-unique rows, `28,860` high-confidence rows, and `24,883` directly usable rows in the current README snapshot, and `auto-research-funds` refreshes its README stats to `8,592` aid IDs, `4,305` rows, and `3,955` official-source rows without replacing the current `D10 / D03 / D02 / D01` family or the headline next-watch `D11 / D08 / D05 / D20` family.
