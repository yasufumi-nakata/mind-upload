...
page_highlights:
  ...
  - "phase-targeting では ms より位相誤差、adaptive DBS では burst 検出遅延と在宅 programming burden が重要です。"
  - "streaming speech BCI では、平均遅延だけでなく tail latency、silence/hold-last-output、再較正負荷を別ログで残す必要があります。"
known_points:
...
<h2 class="section-title">まず 5 つのループ型に分ける</h2>
...
<h2 class="section-title">2026-03 文献監査：長期運用で増える 3 つの壁</h2>
<p>
...
<h2 class="section-title">L3 の主張を読むときの 6 問</h2>
<ol>
