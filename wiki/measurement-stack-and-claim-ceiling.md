...
description: We will organize from primary literature what EEG/MEG/fMRI, whole-brain
  spatial atlas, Patch-seq, volume EM, same-brain functional connectomics, and transmitter/glia
  imaging directly observe and where they hit the claimed upper limits.
article_type: Wiki
...
page_intro: This page is a wiki that fixes the ``upper claim limit for each measurement
  ...
  connectomics, and local transmitter/glia imaging directly observes and what remains
  latent.
