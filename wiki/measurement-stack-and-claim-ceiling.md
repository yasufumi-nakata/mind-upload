...
- Human evidence is also separated into proxy classes, so local ultrastructure, synaptic-density
  ...
  deuterium metabolite-mapping / absolute-quantification routes, deuterium kinetic-rate imaging, ionic / thermal / myelin, BBB, astrocyte, and clearance routes are not compressed
...
- Human 1H-MRSI biochemical similarity, 31P metabolite / pH balance, 31P MT exchange-flux, deuterium metabolite-mapping
  / absolute-quantification routes, deuterium kinetic-rate imaging, ionic, thermal, myelin, BBB, astrocyte, and clearance routes reduce different latent-state
...
<tr>
<td><strong>Human MAO-B astrocyte PET</strong><br>Villemagne et al. (2022); Jaisa-Aad et al. (2024)</td>
<td><strong>MAO-B-related astrocyte proxy</strong></td>
<td>Tracer-specific PET with selegiline-blockade interpretation and region- / disease-regime dependence.</td>
<td>Bounded MAO-B-related astrocyte proxy.</td>
<td>I2BS-related burden, astrocyte-ensemble identity, minute-scale astrocyte-network state, and a route-free whole-brain astrocyte-state scalar.</td>
<td><strong>MAO-B-related astrocyte proxy</strong>. It is not route-free astrocyte-state ground truth.</td>
</tr>
<tr>
<td><strong>Human I2BS astrocyte PET</strong><br>Tyacke et al. (2018); Livingston et al. (2022)</td>
...
<td>MAO-B-related burden, astrocyte-ensemble identity, minute-scale astrocyte-network state, and a route-free whole-brain astrocyte-state scalar.</td>
