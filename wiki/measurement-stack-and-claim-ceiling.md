...
- Astrocyte PET is not one audit item either; SMBT-1 target validation, AD-context
  contrast, brain quantification, whole-body dosimetry, and I2BS routes stay separated.
...
<td>AD-context transfer, stable brain-quantification regime, whole-body dosimetry, I2BS-related burden, astrocyte-ensemble identity, minute-scale astrocyte-network state, and a route-free whole-brain astrocyte-state scalar.</td>
...
<td>I2BS-related burden, astrocyte-ensemble identity, minute-scale astrocyte-network state, whole-body dosimetry, and a route-free whole-brain astrocyte-state scalar.</td>
...
<td>Cross-centre transfer, disease-context calibration, whole-body dosimetry, I2BS-related burden, astrocyte-ensemble identity, and a route-free whole-brain astrocyte-state scalar.</td>
<td><strong>MAO-B brain-quantification proxy</strong>. It is not route-free astrocyte-state ground truth.</td>
</tr>
<tr>
<td><strong>Human SMBT-1 whole-body biodistribution / dosimetry route</strong><br>Mesfin et al. (2026)</td>
...
<td>Bounded tracer-burden / dosimetry proxy.</td>
...
<td><strong>Tracer-burden / dosimetry proxy</strong>. It is not route-free astrocyte-state ground truth.</td>
</tr>
<tr>
...
<td>MAO-B-related target-validation / disease-context / quantification / dosimetry roles, astrocyte-ensemble identity, minute-scale astrocyte-network state, and a route-free whole-brain astrocyte-state scalar.</td>
