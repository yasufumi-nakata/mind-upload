...
note: Technical / natural science only (updated with the 2026-04-03 BCSFB / astrocyte / neuroimmune route-family sync)
...
page_intro: This page is a wiki that fixes the ``upper claim limit for each measurement
  ...
  / ionic / thermal / myelin / BBB / blood-CSF-barrier / choroid-plexus / astrocyte
  target-route-role split / neuroimmune target-route-role split / clearance routes
  directly observes and what remains latent.
...
- Astrocyte PET is not one audit item either; SMBT-1 target validation, AD-context
  contrast, brain quantification, whole-body biodistribution, SL25.1188, and I2BS
  routes stay separated.
- Human evidence is also separated into proxy classes, so local ultrastructure, synaptic-density
  ...
  deuterium metabolite-mapping / absolute-quantification routes, deuterium kinetic-rate imaging, ionic / thermal / myelin, BBB, blood-CSF-barrier / choroid-plexus, astrocyte target / route-role split, neuroimmune target / route-role split, and clearance routes are not compressed into one near-direct readout.
