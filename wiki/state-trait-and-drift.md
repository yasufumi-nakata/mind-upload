---
layout: default
title: "Wiki: state, trait, and drift"
description: "This page organizes same-day state fluctuation, slow internal milieu, trait-like backbone, biological drift, interface / decoder drift, and the Temporal Validity Card using primary literature."
article_type: Wiki
...
wiki_links:
  - label: "Wiki: Uncertainty, calibration, and abstention"
    ...
    description: "Use this page when temporal claims also need confidence, coverage, and fallback logic."
  - label: "Wiki: Closed loops, latency, jitter, and safe stops"
    url: "/wiki/closed-loop-latency-jitter-and-safety-stops.html"
    description: "Use this page when temporal validity intersects with online operation."
  - label: "Wiki: From observation to estimation"
    url: "/wiki/observation-to-estimation.html"
    description: "Use this page when state or backbone claims depend on latent inference rather than direct observation."
recommended_pages:
  - label: "Verification: Temporal Validity Card"
    url: "/verification.html#temporal-validity-card"
  - label: "Datasets: generalization families"
    url: "/datasets.html#generalization-families"
  - label: "EEG 101"
    url: "/eeg_101.html"
---
...
<section class="section" id="four-layers">
<h2 class="section-title">Why the old three-way split is not enough</h2>
<p>
...
<h2 class="section-title">Minimum submission this site now expects for longitudinal claims</h2>
<table class="data-table">
<thead>
<tr>
<th>Item</th>
...
<h2 class="section-title">Operating rules adopted by this site</h2>
<div class="key-points">
<h4>Rule</h4>
<ul>
