...
page_highlights:
  - "同じ信号の中に、state 変動、trait-like な骨格、生体側 drift、signal-chain drift、implant biology drift が同時に混在します。"
  ...
  - "慢性 invasive 記録では、sorting や再較正だけでなく、implant 周囲の血管・BBB・神経細胞・グリアの組織応答も別の drift 軸です。"
...
<section class="section" id="five-buckets">
<h2 class="section-title">まず 5 つに分けて読む</h2>
...
<li>van Beest, E. H., Jia, X., Deng, X., et al. (2025). Tracking neurons across days with high-density probes. <em>Nature Methods</em>, 22, 778-787. <a href="https://doi.org/10.1038/s41592-024-02440-1" target="_blank">doi:10.1038/s41592-024-02440-1</a></li>
