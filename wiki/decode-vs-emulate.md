...
description: "観測の翻訳としての decode と、内部状態を動かす emulate の違いを、日常例と必要な証拠で整理します。"
article_type: Wiki
subtitle: "似ている出力と、同じ仕組みで動いていることは別です"
author: Mind Uploading Research Project
last_updated: "2026-03-06"
note: "Concept guide"
audience: "decode と emulate の違いが曖昧な人、ニュース文言を読み違えたくない人"
reading_time: "8〜12分"
page_intro: "このページは、Mind-Upload で重要な区別である decode と emulate の違いを、初歩から整理する補助ページです。どちらが上かを決めるのではなく、何を主張しているのかが違うことを分けて読むために使います。"
accuracy_note: "ここでの説明は入口用です。実際の評価条件やベンチマーク設計は、対応する公開ページへ戻って確認してください。"
page_highlights:
  - "decode は観測の翻訳、emulate は内部状態が動く系の再現です。"
  - "出力が似ているだけでは、emulate を主張できません。"
  - "どんな証拠が足りるかもレベルごとに違います。"
known_points:
...
wiki_links:
  ...
  - label: "Wiki: EEGの基本"
    ...
    description: "decode の入口になる EEG の性質を補います。"
  - label: "Wiki Home"
    url: "/wiki/"
