...
<p>
Current human evidence is narrower than the rodent causal literature and is already split by molecular target. <a href="https://doi.org/10.2967/jnumed.121.263254" target="_blank">Villemagne et al. (2022)</a> characterized <strong><sup>18</sup>F-SMBT-1 PET</strong> as an MAO-B-selective <strong>reactive-astrogliosis proxy</strong> with pharmacological blockade. <a href="https://doi.org/10.2967/jnumed.118.208009" target="_blank">Tyacke et al. (2018)</a> characterized <strong><sup>11</sup>C-BU99008 PET</strong> as an <strong>imidazoline<sub>2</sub> binding-site (I<sub>2</sub>BS) route</strong> with idazoxan competition and no blockade by isocarboxazid, so it is not the same molecular target as MAO-B PET. <a href="https://doi.org/10.1038/s41380-021-01429-y" target="_blank">Livingston et al. (2022)</a> then showed a regionally dynamic BU99008 pattern in cognitively impaired individuals, with higher uptake in A&beta;-positive MCI than in AD across several cortices. <a href="https://doi.org/10.1007/s00401-024-02712-2" target="_blank">Jaisa-Aad et al. (2024)</a> further showed postmortem that cortical MAO-B is mainly astrocytic but varies across AD/ADRD classes. Therefore, on this site, current human astrocyte PET is read as a <strong>target-defined, disease-regime-dependent astrocyte-related proxy class</strong>, not as one generic human astrocyte-state meter and not as human whole-brain astrocyte-state ground truth.
</p>
</div>
...
<td>For human evidence, disclose whether the route is MAO-B PET, I<sub>2</sub>BS PET, another explicitly named target, only a macro energetic / support proxy, or no human astrocyte-related route at all, together with blocking / competition evidence, disease or cohort regime, and quantification model.</td>
<td>Different molecular targets and stage-dependent directions collapse into <code>astrocyte PET</code>, and a tracer-defined reactive-astrogliosis or I<sub>2</sub>BS proxy is overread as a generic astrocyte-state meter.</td>
</tr>
<tr>
<td><strong>Abstention boundary</strong></td>
...
<td>A target-defined regional MAO-B or I<sub>2</sub>BS astrocyte-related PET route whose interpretation depends on tracer, kinetic model, and disease regime.</td>
