...
page_highlights:
  ...
  - "Bioenergetic evidence is not one class: presynaptic ATP-demand support, dendritic mitochondrial positioning / fission, synaptic ATP-synthase nano-organization, mitochondrial Ca2+-efflux tuning, human 31P metabolite / pH balance, human 31P MT exchange-flux, human 31P NAD-content / functional routes, and deuterium metabolite / rate imaging should be audited separately with a route card."
...
known_points:
  ...
  - "Bioenergetic evidence already spans presynaptic ATP-linked respiration, dendritic positioning / fission, synaptic ATP-synthase nano-organization, conserved mitochondrial Ca2+-efflux tuning, and human 31P metabolite / pH, 31P exchange-flux, 31P NAD, plus deuterium proxy routes, so one energetic paper does not settle local mitochondrial state."
...
unknown_points:
  ...
  - "It has not been fixed which external standards among SV2A PET, MRSI, MRS thermometry, 31P metabolite / pH, 31P MT exchange-flux, 31P NAD routes, sodium MRI, dynamic DMI, quantity-defined myelin MRI routes, BBB water-exchange MRI / tracer-specific PET transport, TMS-EEG, sleep-plasticity proxies, and CSF-glymphatic proxies should calibrate maintenance-states that cannot be measured directly in humans."
...
<tr>
<td><strong>Claim family</strong></td>
<td>State whether the result supports <strong>presynaptic ATP-demand support</strong>, <strong>dendritic plasticity support</strong>, <strong>organelle micro-organization</strong>, <strong>metabolic-tuning intervention</strong>, <strong>human 31P metabolite / pH balance</strong>, <strong>human 31P MT exchange-flux</strong>, <strong>human 31P NAD-content / functional route</strong>, or <strong>human deuterium metabolite / rate imaging</strong>.</td>
...
<tr>
<td><strong>Human observability / external calibration</strong></td>
<td>State whether the human route is a <strong>31P metabolite / pH balance</strong>, <strong>31P MT exchange-flux</strong>, <strong>31P NAD-content / functional route</strong>, or <strong>deuterium metabolite / rate</strong> proxy and what local mitochondrial variables still require external calibration.</td>
...
<li><strong>Do not mix human proxy classes:</strong>Do not collapse EM fragments, whole-brain MRSI, 31P-MRS / sodium MRI / dynamic DMI, myelin bilayer map, sleep / TMS proxy into the same "human-seen" word. </li>
...
<td>Energetic proxy such as 31P metabolite / pH balance, 31P MT exchange-flux, 31P NAD route, or dynamic DMI, fatigue / repeated-burst failure log if possible, bioenergetic state set to fixed background, unmeasured mitochondrial positioning / redox reserve. </td>
</tr>
<tr>
