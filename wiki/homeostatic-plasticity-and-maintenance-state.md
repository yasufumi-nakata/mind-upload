...
page_highlights:
  ...
  - "Neurovascular / BBB evidence is not one class: adult pericyte loss and neurovascular uncoupling, pericyte-to-neuron memory signaling, activity-dependent BBB modulation, capillary-diameter controllers, and human BBB permeability proxies should be audited separately with a route card."
  ...
  - "Human-side advances must also be read as evidence for another layer: EM fragments, synaptic-density proxies by SV2A PET, whole-brain MRSI, MRS thermometry, myelin bilayer maps, BBB permeability proxies, astrocyte PET routes, sleep / TMS proxies, and CSF / glymphatic proxies."
...
known_points:
  ...
  - "Even in humans, macro scaffolds and support-state proxies are starting to become visible through SV2A PET, MRSI-based metabolic connectomes, MRS thermometry, 31P-MRS, sodium MRI, dynamic deuterium metabolic imaging, myelin bilayer mapping, BBB permeability MRI / PET, TMS / EEG / sleep plasticity proxies, and CSF / glymphatic proxies, although cell-specific maintenance-states still remain coarse."
...
unknown_points:
  ...
  - "It is not yet fixed which same-subject or human-compatible external calibrators could raise neurovascular-unit / BBB claims beyond macro permeability proxy evidence."
  - "It has not been fixed which external standards among SV2A PET, MRSI, MRS thermometry, 31P-MRS, sodium MRI, dynamic DMI, myelin bilayers, BBB permeability MRI / PET, TMS-EEG, sleep-plasticity proxies, and CSF-glymphatic proxies should calibrate maintenance-states that cannot be measured directly in humans."
