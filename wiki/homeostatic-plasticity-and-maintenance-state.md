...
known_points:
  ...
  - "Even in humans, macro scaffolds and support-state proxies are starting to become visible through SV2A PET, MRSI-based metabolic connectomes, MRS thermometry, 31P metabolite / pH balance, 31P MT exchange-flux, 31P NAD-content mapping, 31P functional NAD-dynamics routes, sodium MRI, dynamic deuterium metabolic imaging, quantity-defined myelin MRI routes, BBB water-exchange MRI / tracer-specific transport PET, target-defined astrocyte PET, TMS / EEG / sleep plasticity proxies, and CSF / glymphatic proxies, although cell-specific maintenance-states still remain coarse."
...
<td>For human evidence, state whether the route measures <strong>macroscopic CSF oscillation</strong>, <strong>parenchyma-CSF water exchange</strong>, <strong>CSF mobility in SAS / PVS</strong>, <strong>intrathecal tracer retention</strong>, <strong>CSF-to-blood clearance capacity</strong>, or <strong>model-based brain-to-plasma biomarker efflux</strong>.</td>
...
<td>Report which physiology-linked driver was measured or manipulated, such as <strong>slow-wave EEG</strong>, <strong>BOLD / blood-volume oscillation</strong>, <strong>heart rate / HRV</strong>, <strong>respiration</strong>, <strong>vasomotion</strong>, <strong>arterial compliance</strong>, <strong>sleep deprivation</strong>, or a <strong>device-derived parenchymal-resistance proxy</strong>.</td>
...
<td>Macro support-state proxy, not local clearance / immune-controller ground truth.</td>
</tr>
</tbody>
</table>
<p>
