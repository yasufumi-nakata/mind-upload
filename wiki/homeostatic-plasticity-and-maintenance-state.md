...
<td>For human evidence, disclose whether the route is MAO-B PET, I<sub>2</sub>BS PET, another explicitly named target, only a macro energetic / support proxy, or no human astrocyte-related route at all, together with blocking / competition evidence, quantification route such as validated scan window / reference region or kinetic model, disease or cohort regime, and material covariates such as smoking or recent substance exposure.</td>
<td>Different molecular targets, quantification routes, and stage- or covariate-dependent directions collapse into <code>astrocyte PET</code>, and a tracer-defined reactive-astrogliosis or I<sub>2</sub>BS proxy is overread as a generic astrocyte-state meter.</td>
</tr>
<tr>
<td><strong>Abstention boundary</strong></td>
...
<tr>
<td><strong>Astrocyte PET (MAO-B / I<sub>2</sub>BS routes)</strong><br>Villemagne et al. (SMBT-1 first-in-human / AD-spectrum); Tyacke et al.; Livingston et al.</td>
<td>Target-defined astrocyte-related proxy with an MAO-B or I<sub>2</sub>BS PET route whose reading still depends on target-validation versus disease-context paper, disease regime, and kinetic model.</td>
