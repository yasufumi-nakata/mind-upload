---
layout: default
title: "Wiki：不確実性・校正・棄権"
description: "EEG source imaging、EEG分類、closed-loop BCI における uncertainty、calibration、abstention を一次文献ベースで整理します。"
article_type: Wiki
subtitle: "confidence はそのまま信頼度ではありません。校正と coverage を分けて見ます"
author: Mind Uploading Research Project
last_updated: "2026-03-16"
note: "Technical / natural science only"
audience: "点推定だけの主張を避けたい人、校正と棄権を実務指標として理解したい人"
reading_time: "12〜18分"
page_intro: "このページは、Mind-Upload で頻出する『不確実性』『信頼区間』『信用区間』『校正』『棄権』を、EEG source imaging、EEG分類、closed-loop BCI の一次文献に寄せて整理する wiki です。数字が 1 つ出たときにどこまで信じてよいかだけでなく、いつ出力を止めるべきかまで含めて扱います。"
accuracy_note: "ここでは統計学の完全な教科書説明より、技術・自然科学の監査項目を優先します。厳密な定義を省略する箇所はありますが、『confidence と calibration は別』『coverage を下げれば risk は下げられる』『online 系では再較正負荷も性能』という要点は曖昧にしません。"
page_highlights:
  - "confidence と calibration は別であり、softmax や posterior の 1 数字だけでは安全性は読めません。"
  - "同じ ECE や coverage でも、within-session / cross-session / cross-subject / temporal shift では意味が変わります。"
  - "source imaging、EEG分類、closed-loop BCI では、公開すべき不確実性指標が違います。"
  - "棄権は弱気ではなく、coverage と risk の交換条件を公開する運用です。"
known_points:
...
<h2 class="section-title">confidence、区間、校正、棄権を混ぜない</h2>
<table class="data-table">
<thead>
<tr>
<th>概念</th>
...
<h2 class="section-title">校正は fit / calibration / test を分けて管理します</h2>
<table class="data-table">
<thead>
<tr>
<th>段階</th>
...
<h2 class="section-title">同じ calibration でも evaluation family が違えば意味が変わります</h2>
<table class="data-table">
<thead>
<tr>
...
<h2 class="section-title">確率・区間・予測集合・棄権は別の出力です</h2>
<table class="data-table">
<thead>
<tr>
<th>出力の型</th>
...
<h2 class="section-title">不確実性は 4 つの層で生まれます</h2>
<table class="data-table">
<thead>
<tr>
<th>層</th>
...
<h2 class="section-title">課題ごとに公開すべき指標を変えます</h2>
<table class="data-table">
<thead>
<tr>
<th>課題</th>
...
<li><strong>確率・区間・予測集合・棄権を前面に出す結果には Calibration &amp; Abstention Card を添付する：</strong><a href="../verification.html#calibration-abstention-card">Verification</a> 側の共通提出物で split、slice、coverage-risk、fallback policy を固定します。</li>
</ul>
</div>
</section>
...
<p>
source imaging 側へ戻るなら <a href="observation-to-estimation.html">観測から推定へ</a>、closed-loop 側へ戻るなら <a href="closed-loop-latency-jitter-and-safety-stops.html">閉ループ・遅延・ジッタ・安全停止</a>、公開ルール全体へ戻るなら <a href="../verification.html">検証基盤</a> をご利用ください。
</p>
</section>
