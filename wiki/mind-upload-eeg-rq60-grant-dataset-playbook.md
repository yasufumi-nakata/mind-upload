...
- The practical funding bridge for this batch is led by `Nakatani Foundation graduate scholarship`, `Kura Fund`, `Kashinome Scholarship`, and `Nakatani Foundation research grant`.
