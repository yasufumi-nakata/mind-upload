---
layout: default
title: "Wiki: U7-2 timing-metric route packet"
description: "Why U7-2 is the next metric-focused synchronization row to deepen, why D11 stays the public-open first anchor, and what release-block timing artifact can honestly close now."
article_type: Wiki
subtitle: "An adjacent synchronization packet outside the current public six"
author: Mind Uploading Research Project
last_updated: "2026-04-02"
note: "U7-2 route packet"
audience: "Readers who want one public-safe route for turning synchronization error into explicit metrics without widening the public claim surface"
reading_time: "8-12 minutes"
page_intro: "This page records one narrow row just outside the current public six at the level of one question, one public-open EEG anchor, one bounded first artifact, and one funding bridge."
accuracy_note: "This page does not change the active public six-question batch. It only records what the present U7-2 timing-metric route can honestly close first."
wiki_links:
  ...
  - label: "Wiki: U7-1 synchronization-contract route packet"
    ...
    description: "The contract-first row that sits immediately next to this metric-first packet."
  - label: "Wiki: Event synchronization and measurement logs"
    url: "/wiki/event-sync-and-measurement-logs.html"
    description: "The timing-log page that keeps this row grounded in observable fields."
