...
page_highlights:
  ...
  - "Operational promotion also needs a stability / nuisance audit and, when energetic language is used, an explicit same-session physiology bridge rather than a loose multimodal pairing."
...
<h2 class="section-title">Nine questions when reading thermodynamic claims</h2>
<ol>
