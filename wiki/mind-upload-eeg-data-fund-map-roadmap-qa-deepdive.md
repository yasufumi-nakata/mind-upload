---
layout: default
title: "Wiki：Roadmap 51QA × EEG-DATA × 助成テーマ深掘り"
description: "tech_roadmap.md の 51QA を1件ずつ、EEG-DATAで検証可能か、どの助成テーマで出すか、どのデータスライスを使うかまで落とし込んだ実務ページ。"
article_type: Wiki
subtitle: "P/M/R/I/V/D の各QAを問い単位で判定・助成化"
author: Mind Uploading Research Project
last_updated: "2026-03-13"
note: "Roadmap QA deep dive"
audience: "mind-upload のリサーチクエスチョンを1件ずつ助成テーマへ変換したい人"
reading_time: "40〜80分"
page_intro: "このページは tech_roadmap.md の 51QA を、EEG-DATAでどこまで検証できるかを問い単位で判定し、auto-research-funds 向けの申請テーマ、使うEEG-DATAスライス、初期指標、12週成果物まで固定した深掘り版wikiです。"
accuracy_note: "助成制度の応募資格・締切・様式は変動するため、実応募前に制度本文を必ず確認してください。"
page_highlights:
  - "51QAすべてを、○/△/× でEEG-DATA可否判定します。"
  - "各QAで、助成テーマ・推奨支援レーン・使うデータスライスを指定します。"
  - "companion CSV でそのまま申請下書きに使える粒度にしています。"
known_points:
