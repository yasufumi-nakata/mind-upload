...
page_highlights:
  ...
  - "Human proxy bundles are now read on three axes first: proxy class, operational maturity, and calibrator role."
...
known_points:
  ...
  - "The same mismatch now applies to neurovascular support: pericyte / BBB causality and human BBB permeability proxies are different evidential rows, so vascular audit does not by itself identify the responsible neurovascular controller."
...
<td>Cell-specific chloride homeostasis, branch-local mitochondrial positioning, current phospho-signaling nanodomain state, branch-specific cargo delivery, local immune-controller / synaptic-maintenance logic, or same-subject whole-brain hidden-state closure.</td>
</tr>
</tbody>
</table>
<p>
At Mind-Upload, the safe reading is now <strong>three-axis</strong>: name <strong>which proxy class the route constrains</strong>, separately name <strong>how specialized, small-cohort, or model-heavy the route still is</strong>, and then state <strong>what bounded calibrator role the route safely plays</strong>. If you skip that third step, you can silently turn <strong>"real human route"</strong> into <strong>"broad hidden-state calibration"</strong>. If you skip the second, you can silently turn <strong>"human evidence got richer"</strong> into <strong>"human state-complete measurement is close"</strong>. The current primary literature does not support either jump.
</p>
<p>
...
<div class="note-box">
<strong>Seven quick checks behind the three-gate rule</strong>
<ul>
