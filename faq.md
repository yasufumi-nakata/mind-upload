...
known_points:
  ...
  - "Because wiring diagrams and cell types still leave excitability, timing-state, thermal-state, transcription/chromatin, post-transcriptional RNA-state, proteostasis, cargo-transport / cytoskeletal trafficking state, ECM / PNN, ionic-homeostasis, bioenergetic / mitochondrial state, astrocyte / glial-state, clearance / immune support, and other maintenance-support variables unresolved, long-term dynamical claims require separate auditing."
...
<td>A flux map, a wiring graph, or current transcription / chromatin / post-transcriptional / proteostasis control.</td>
</tr>
<tr>
...
<td>Cell-specific chloride homeostasis, branch-local mitochondrial positioning, branch-specific cargo delivery, local immune-controller / synaptic-maintenance logic, or same-subject whole-brain hidden-state closure.</td>
</tr>
</tbody>
</table>
<p>
