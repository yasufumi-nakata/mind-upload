# rq60_eeg_funds_revalidation_2026-03-20_1902JST

## 実行時刻
- 2026-03-20 19:02 JST
...
4. 助成ID（`GR-2026-013`, `GR-2026-014`, `G3-G6`, 追加候補）を `grant_queue/*.yaml` と `auto-research-funds/wiki/cards/*.md` で実在確認。

## 確認結果
- RQ件数: `60`（`U0=4 U1=4 U3=6 U4=4 U7=6 U8=6 U10=4 U11=4 U12=6 U13=6 U14=6 U15=4`）
- 判定内訳: `A/B/C = 17/25/18`
- EEG ID 24件: 欠落 `0`
  - `6,11,13,16,19,29,39,49,56,65,509,676,696,719,735,783,842,859,1011,1839,1972,2412,3419,4878`
- 助成ID: 欠落 `0`
...
## 判断
- 方針を維持: `1RQ=1検証命題=1応募テーマ=1主データ`。
- 提出時のデータキーは `ID` 依存を避け、`DOI + dataset名 + access区分` を正本とする。
