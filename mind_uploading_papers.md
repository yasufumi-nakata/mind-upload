...
known_points:
  ...
  - "Neurovascular / BBB / pericyte papers do not constrain one common current-state object: pericyte controller causality, activity-linked BBB modulation, capillary-diameter control, and human BBB permeability imaging remain separate routes."
...
last_updated: "2026-04-02"
note: "Curated archive (updated with the 2026-04-02 route-family, post-transcriptional-RNA literature sync, myelin front-door, presynaptic-release-machinery ceiling sync, and phospho-route front-door sync)"
...
page_highlights:
  ...
  - "Neurovascular / BBB / pericyte papers are now treated as a distinct route-family split because pericyte support causality, activity-linked BBB modulation, capillary-diameter control, and human BBB permeability routes answer different questions."
...
<tr>
<td><strong>neurovascular / BBB / pericyte route-card split</strong></td>
...
<td>It becomes concrete that <strong>pericyte controller causality</strong>, <strong>activity-linked BBB modulation</strong>, <strong>capillary-diameter support for memory</strong>, and <strong>human BBB permeability / exchange imaging</strong> are related but non-identical route families. Controller-side biology and macro human permeability proxy are no longer safe to collapse into one vascular bucket.</td>
<td>These papers do not provide a direct human readout of cell-specific neurovascular-controller state, synapse-resolved support control, or local BBB-maintenance closure, and the human routes still remain macro permeability / exchange proxies rather than local controller measurements.</td>
