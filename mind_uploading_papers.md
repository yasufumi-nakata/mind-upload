...
known_points:
  ...
  - "Invasive BCI papers are no longer treated as one closed-loop progress bar: communication throughput / expressivity, fixed-decoder durability, and adaptive stabilization / recalibration are separate operational routes."
...
page_highlights:
  ...
  - "Invasive BCI papers are now read on three operational routes: communication speed / expressivity, fixed-decoder durability, and adaptive stabilization / recalibration."
...
<p>
The weakness of this page is that although it is useful as a <strong>chronological archive</strong>, the ordering is weak as a <strong>front door to the experimental frontier</strong>. From a technology / natural-science perspective, the first thing we want to know is (1) how far non-invasive decoding has progressed, (2) how far invasive speech neuroprosthesis has pushed the same-session communication route, (3) whether that communication survives fixed-decoder horizons or only after adaptive rescue, (4) how far source imaging can be audited with direct validation, (5) how EEG foundation / self-supervised results change once corpus disclosure, adaptation regime, split construction, and inference-stage budget are held fixed, (6) how effective-connectivity models remain conditional on candidate model space and observation assumptions even when they scale, (7) what really becomes stronger with multimodal integration and where it hits the hemodynamic proxy ceiling, (8) what humans can actually observe now, at which measurement class, and with what remaining route burden, (9) when a same-subject or same-brain result is still only a <strong>sequential bridge</strong> rather than one latent-state sample, (10) which maintenance-state families, including intrinsic-excitability control, ionic / chloride regulation, bioenergetic / mitochondrial support, neurovascular-unit / BBB / pericyte support, clearance / immune support, transcriptional stabilization, and astrocyte-state, still remain outside the connectome, and (11) how thermodynamic / irreversibility papers split into different estimator families instead of one common physical-grounding result. It is about how much remains, not the first display of law, philosophy, or cultural theory. Therefore, on this page, we clearly indicate the following as the <strong>preferred route</strong>.
</p>
...
<td>Achieves high-vocabulary text decoding, streaming brain-to-voice, near-instant voice synthesis, and cross-subject transfer learning for phoneme decoding under distributed sEEG coverage. This strongly pushes the <strong>same-session communication subsystem</strong> and <strong>decoder-initialization strategy</strong> frontier.</td>
<td>Whole-brain emulation, identity preservation, subject-general everyday communication, <strong>fixed-decoder durability</strong>, and zero-recalibration autonomy have not yet been demonstrated.</td>
...
<tr>
<td><strong>Long-horizon BCI durability / recalibration route</strong></td>
<td><a href="https://doi.org/10.1038/s41467-025-59652-y" target="_blank">Karpowicz et al. (2025)</a>, <a href="https://doi.org/10.1038/s41551-025-01536-z" target="_blank">Wilson et al. (2025)</a>, <a href="https://doi.org/10.1038/s41586-025-09127-3" target="_blank">Wairagkar et al. (2025)</a></td>
<td>Adaptive stabilization and unsupervised recalibration can preserve useful control across weeks to months despite accumulating neural changes, and fixed-decoder degradation can be measured rather than hidden behind rescue. This directly strengthens the <strong>temporal-durability audit</strong>, not just the communication metric.</td>
...
<div class="note-box">
<strong>Read invasive BCI papers through a durability split as well</strong>
<p>
The archive also becomes too easy to overread if a reader sees <strong>one day of fluent speech</strong> and silently treats it as the same result as <strong>weeks of stable use</strong>. The primary literature does not support that shortcut either. <a href="https://doi.org/10.1038/s41586-023-06377-x" target="_blank">Willett et al. (2023)</a> and <a href="https://doi.org/10.1038/s41593-025-01905-6" target="_blank">Littlejohn et al. (2025)</a> push communication speed itself. <a href="https://doi.org/10.1038/s41586-025-09127-3" target="_blank">Wairagkar et al. (2025)</a> adds <strong>sub-10-ms</strong> voice synthesis with explicit <strong>silence fallback</strong>, but the same paper also reports a noticeable decline in a fixed decoder after about <strong>15 days</strong>. <a href="https://doi.org/10.1038/s41467-025-59652-y" target="_blank">Karpowicz et al. (2025)</a> then shows that alignment of latent dynamics can stabilize BCI decoding over longer spans, and <a href="https://doi.org/10.1038/s41551-025-01536-z" target="_blank">Wilson et al. (2025)</a> shows one month of unsupervised recalibration plus offline characterization over five years. Therefore, this archive now separates <strong>communication throughput / expressivity</strong>, <strong>fixed-decoder durability</strong>, and <strong>adaptive stabilization / recalibration</strong> before any invasive BCI is read as long-horizon autonomy.
</p>
</div>
<div class="note-box">
...
<tr>
<td><strong>temporal durability / adaptive stabilization</strong></td>
<td><a href="https://doi.org/10.1038/s41467-025-59652-y" target="_blank">Karpowicz 2025</a>, <a href="https://doi.org/10.1038/s41551-025-01536-z" target="_blank">Wilson 2025</a>, <a href="https://doi.org/10.1038/s41586-025-09127-3" target="_blank">Wairagkar 2025</a></td>
<td>Fixed-decoder interval, degradation curve, alignment-based rescue, unsupervised recalibration route, and recovery burden for longer use.</td>
...
<td>Start with <a href="https://doi.org/10.1038/s41586-023-06377-x" target="_blank">Willett 2023</a>, <a href="https://doi.org/10.1038/s41593-025-01905-6" target="_blank">Littlejohn 2025</a>, <a href="https://doi.org/10.1038/s41586-025-09127-3" target="_blank">Wairagkar 2025</a>, and <a href="https://doi.org/10.1038/s41467-025-63825-0" target="_blank">Singh 2025</a>, then check latency, silence / abstention, and whether the gain is <strong>same-session streaming output</strong> or <strong>cross-subject transfer initialization</strong>. </td>
</tr>
<tr>
<td><strong>I want to read long-horizon BCI durability / recalibration</strong></td>
<td>Start with <a href="https://doi.org/10.1038/s41467-025-59652-y" target="_blank">Karpowicz 2025</a>, <a href="https://doi.org/10.1038/s41551-025-01536-z" target="_blank">Wilson 2025</a>, and the fixed-decoder analysis in <a href="https://doi.org/10.1038/s41586-025-09127-3" target="_blank">Wairagkar 2025</a>, then separate <strong>fixed-decoder interval</strong>, <strong>alignment or recalibration route</strong>, <strong>recovery burden</strong>, and <strong>task / interface transfer ceiling</strong> before calling the system durable.</td>
</tr>
<tr>
