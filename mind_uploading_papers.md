...
<p>
This refresh adds four explicit corrections. First, human measurement papers now have to be read on <strong>two axes</strong>: <strong>which proxy class they constrain</strong> and <strong>how specialized or model-heavy the route still is</strong>. <a href="https://doi.org/10.1093/pnasnexus/pgaf072" target="_blank">Li et al. (2025)</a> adds kinetic glucose-rate imaging by dynamic DMRSI, while <a href="https://doi.org/10.1038/s41467-026-68374-8" target="_blank">Dagum et al. (2026)</a> adds sleep-linked clearance physiology with an investigational wearable plus a compartment model; neither is the same inferential object as a static MRSI graph or a routine whole-brain readout. Second, same-subject or same-brain papers now have to pass a <strong>bridge audit</strong>: <a href="https://doi.org/10.1016/j.crmeth.2023.100520" target="_blank">Lu et al. (2023)</a>, <a href="https://doi.org/10.1038/s41467-022-30199-6" target="_blank">Bosch et al. (2022)</a>, <a href="https://doi.org/10.1038/s41586-025-08790-w" target="_blank">MICrONS Consortium et al. (2025)</a>, and <a href="https://doi.org/10.1038/s41598-024-70609-x" target="_blank">Egger et al. (2024)</a> together show that preservation route, acquisition order, bridge validation, and cross-day regime drift materially change what those labels are allowed to mean. Third, the maintenance-state route now includes <strong>transcriptional stabilization gates</strong> and <strong>astrocyte multiday traces</strong> alongside sleep, myelin, and metabolic support, reflecting <a href="https://doi.org/10.1038/s41586-025-09774-6" target="_blank">Terceros et al. (2025)</a>, <a href="https://doi.org/10.1038/s41586-025-09619-2" target="_blank">Dewa et al. (2025)</a>, and <a href="https://doi.org/10.1038/s41586-025-10068-0" target="_blank">Bukalo et al. (2026)</a>. Fourth, EEG foundation-model papers now have to be paired with <strong>benchmark-governance evidence</strong>: <a href="https://doi.org/10.3389/fnhum.2021.653659" target="_blank">Kostas et al. (2021)</a>, <a href="https://proceedings.iclr.cc/paper_files/paper/2024/hash/47393e8594c82ce8fd83adc672cf9872-Abstract-Conference.html" target="_blank">Jiang et al. (2024)</a>, <a href="https://openreview.net/forum?id=J5SbLoq7Uv" target="_blank">Lee et al. (2025)</a>, the official <a href="https://eeg2025.github.io/leaderboard/" target="_blank">EEG Challenge 2025 leaderboard</a>, <a href="https://arxiv.org/abs/2508.17742" target="_blank">Xiong et al. (2025)</a>, and <a href="https://arxiv.org/abs/2603.02268" target="_blank">Lahiri et al. (2026)</a> together show that corpus disclosure, split construction, inference-stage rules, and benchmark inconsistency can move what a leaderboard score actually means.
</p>
</div>
