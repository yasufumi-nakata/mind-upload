...
known_points:
  ...
  - "Recent maintenance-state papers now split across intrinsic-excitability control, transcriptional stabilization, post-transcriptional RNA control, phospho-signaling, local proteostasis, cargo-routing, ionic / chloride regulation, bioenergetic / mitochondrial support, clearance / immune support, and astrocyte-state evidence, so they should not be filed only as generic background on support variables."
...
page_highlights:
  ...
  - "Recent maintenance-state papers are treated here as route-changing family-split evidence because intrinsic-excitability control, transcriptional stabilization, post-transcriptional RNA control, phospho-signaling, local proteostasis, cargo-routing, ionic / chloride regulation, bioenergetic / mitochondrial support, clearance / immune support, and astrocyte multiday traces remain outside connectome-only reading."
...
<td>It becomes much clearer which <strong>living-human in vivo</strong> advances are regional synaptic-density PET, macro biochemical scaffold, kinetic glucose-rate imaging, macro myelin / thermal proxy, and CSF-mobility or sleep-linked clearance physiology. Just as importantly, these papers differ in <strong>safe calibrator role</strong>: the route can calibrate regional synaptic-density contrast, parcel-level metabolite similarity, macro energetic-rate imaging, bounded myelin / thermal proxy classes, or clearance-support physiology without becoming one common state meter.</td>
...
<td>What living humans can directly observe or approximate at each measurement class: regional synaptic-density PET, macro biochemical scaffold, kinetic glucose-rate imaging, macro myelin / thermal proxy, and macro support-state / clearance proxy.</td>
...
<td>Degeneracy of excitability, sleep-dependent recovery, myelin/metabolic support, transcriptional stabilization, astrocyte multiday trace, and connectome-constrained dynamics still remain outside cell-type and graph description alone.</td>
