...
known_points:
  ...
  - "Recent maintenance-state papers now split across intrinsic-excitability control, transcriptional stabilization, post-transcriptional RNA control, phospho-signaling, local proteostasis, cargo-routing, ionic / chloride regulation, bioenergetic / mitochondrial support, neurovascular-unit / BBB / pericyte support, clearance / immune support, and astrocyte-state evidence, so they should not be filed only as generic background on support variables."
...
page_highlights:
  ...
  - "Recent maintenance-state papers are treated here as route-changing family-split evidence because intrinsic-excitability control, transcriptional stabilization, post-transcriptional RNA control, phospho-signaling, local proteostasis, cargo-routing, ionic / chloride regulation, bioenergetic / mitochondrial support, neurovascular-unit / BBB / pericyte support, clearance / immune support, and astrocyte multiday traces remain outside connectome-only reading."
