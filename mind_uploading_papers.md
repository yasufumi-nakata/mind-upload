...
<td>Fixed-decoder interval, degradation curve, and instability metrics that expose when drift breaks the originally trained interface.</td>
<td>It is not evidence that rescue is solved, that drift can be ignored, or that the system is already deployable across tasks, interfaces, and users.</td>
</tr>
<tr>
...
<td><a href="https://doi.org/10.1016/j.crmeth.2023.100520" target="_blank">Lu 2023</a>, <a href="https://doi.org/10.1126/science.adk4858" target="_blank">Shapson-Coe 2024</a>, <a href="https://doi.org/10.1038/s41586-024-07558-y" target="_blank">Dorkenwald 2024</a>, <a href="https://doi.org/10.1038/s41586-025-08790-w" target="_blank">MICrONS 2025</a></td>
<td>What destructive ultrastructure can directly strengthen when route burdens are disclosed: local ex vivo structural scaffold, same-brain local structure-function linkage, and explicit preservation / registration / proofreading constraints.</td>
<td>It is not live native-state capture, same-time whole-brain state measurement, or finished error-free whole-brain readiness.</td>
</tr>
<tr>
