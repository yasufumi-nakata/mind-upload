...
known_points:
  ...
  - "Recent maintenance-state papers now split across intrinsic-excitability control, transcriptional stabilization, post-transcriptional RNA control, phospho-signaling, local proteostasis, cargo-routing, ECM / PNN gate state, ionic / chloride regulation, bioenergetic / mitochondrial support, glial substrate-routing, neurovascular-unit / BBB / pericyte support, clearance / immune support, and astrocyte-state evidence, so they should not be filed only as generic background on support variables."
...
note: "Curated archive (updated with the 2026-04-03 paper-front-door human-proxy route sync, including spectroscopy / deuterium operating-point, BCSFB route-family, astrocyte PET route-role, neuroimmune PET route-family summary-layer splits, and a glial substrate-routing stop rule)"
