...
<section class="booklet-sheet booklet-page-break">
  ...
  <div class="booklet-quote">
    <p>Connectome-complete does not mean emulation-complete; missing maintenance-state variables must be audited separately. / Human evidence is layered: local ultrastructure, synaptic-density PET, receptor / transporter atlas priors, occupancy / displacement PET, m…</p>
  </div>
</section>
