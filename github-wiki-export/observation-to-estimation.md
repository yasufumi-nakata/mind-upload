...
- [Wiki: Observability and claim ceiling by measurement stack](https://github.com/yasufumi-nakata/mind-upload/wiki/measurement-stack-and-claim-ceiling) - Use this when you first need to separate direct observables from latent state families before asking identifiability questions.
- [Wiki: Multimodal integration basics](https://github.com/yasufumi-nakata/mind-upload/wiki/multimodal-integration-basics) - Use this when richer stacks could otherwise be misread as self-validating fusion.
...
- For ESI, method/package/parameter choice can materially move the estimated source, and probabilistic / debiased / extent-aware inverse families do not report the same claim object by default.
...
- Whole-brain or faster DCM improves tractability, but does not erase candidate-model dependence, processing-policy sensitivity, or observation-model assumptions.
...
<h2>Six audit gates to be fixed first</h2>
<table>
<thead>
<tr>
<th>Audit gate</th>
