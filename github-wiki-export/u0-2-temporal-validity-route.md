...
- The main change in this sync is that `U0-2` now carries the same `2026-04-04 01:04 JST` route basis as the front-door pages and records that the live row packet had been stale before this source update.
