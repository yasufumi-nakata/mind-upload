# Wiki: U13-5 perception-to-recall route packet

> A row-specific packet for the second active public RQ
>
> This learning page is generated for GitHub Wiki. The public portal is managed on [mind-upload.com](https://mind-upload.com).

- Updated: 2026-03-30 / Role: U13-5 route packet

## Role Of This Page
This page fixes the current public route for U13-5 at the level of one question, one primary dataset anchor, one bounded first artifact, and one funding bridge.

## Accuracy Notes
This page does not claim shared internal mechanism across perception and recall. It only records what the present EEG route can honestly close first.
