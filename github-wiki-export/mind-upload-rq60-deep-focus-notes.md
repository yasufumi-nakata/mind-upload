# マインドアップロード RQ60 ディープフォーカスノート (EEG-DATA × Grant)

> 一般的な概要ではなく、各 RQ の問題を修正する
>
> この学習ページは GitHub Wiki 用に生成されています。公開ポータルは [mind-upload.com](https://mind-upload.com) で管理しています。

- Updated: 2026-04-02 / Role: RQ ごとのディープ フォーカス

## このページの役割
このページは、EEG-DATAで直接確認できるmind-uploadの60件のRQの核心、自動研究資金の申請テーマ、脳波外で必要な要件などを修正した実践ノートです。

## 正確性に関する注記
A/B/C 判定は、mind-upload-eeg-rq60-feasibility-and-funds と同じです。 Cは「重要ではない」というよりは「脳波だけでは完了しない」という意味です。
...
## 関連 Wiki ページ
- [Wiki: RQ60 EEG検証の利用可能性と補助金テーマ](https://github.com/yasufumi-nakata/mind-upload/wiki/mind-upload-eeg-rq60-feasibility-and-funds) - オリジナル版の判定とデータ候補。
- [Wiki: RQ60 アプリケーション プレイブック](https://github.com/yasufumi-nakata/mind-upload/wiki/mind-upload-eeg-rq60-grant-dataset-playbook) - 申請者 ID と最小成果物の表を修正しました。
