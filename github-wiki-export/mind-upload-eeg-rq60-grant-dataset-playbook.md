# Mind-upload RQ60 アプリケーション プレイブック (RQ ユニット固定)

> 一般的な要約ではなく、RQ に基づいて提出の決定を修正する
>
> この学習ページは GitHub Wiki 用に生成されています。公開ポータルは [mind-upload.com](https://mind-upload.com) で管理しています。

- Updated: 2026-04-04 / Role: RQ ごとの助成金とデータセットのハンドブック

## このページの役割
このページは、mind-uploadの60のリサーチクエスチョンをそれぞれ対象とし、一次応募先・予備応募先、主なEEG-DATA、採用理由、提出成果物を固定化した実践的なプレイブックです。

## 正確性に関する注記
A/B/C判定は`mind-upload-eeg-rq60-feasibility-and-funds.md`と同じ基準となります。
...
## 関連 Wiki ページ
- [Wiki: RQ60 EEG検証の利用可能性と補助金テーマ](https://github.com/yasufumi-nakata/mind-upload/wiki/mind-upload-eeg-rq60-feasibility-and-funds) - 判断根拠、U 固有の背景、RQ 表の原本。
- [Wiki: 検証インフラストラクチャの基本](https://github.com/yasufumi-nakata/mind-upload/wiki/verification-basics) - 成果物を検証仕様に変換するための基準。
