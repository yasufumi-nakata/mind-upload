# Wiki: ソースタイプ、ステータスラベル、証拠クラスの読み方

> バッジ、ソース、ステータス、論文が直接強化する内容の混乱を避けるための補助ページ
>
...
## このページの役割
このページは、「`Scopus,'' ``arXiv,'' ``Review,'' ``Media,'' ``source_logged,'' ``curated」などのラベルや、コレクションや書誌マップに登場する証拠クラスを初心者向けに整理した補助ページです。ここで重要なことは、これらのラベルを個別に読み、それぞれがどのような情報を表しているのかを理解することです。

## 正確性に関する注記
ラベルは読みやすさを補助するものであり、記事の内容の正確性を自動的に保証するものではありません。証拠として使用する場合は、必ず DOI、本文、一次研究を参照してください。
...
## 関連 Wiki ページ
- [Wiki: 文献と証拠のページの読み方](https://github.com/yasufumi-nakata/mind-upload/wiki/literature-and-evidence-reading) - まず、論文集、書誌地図、企画書ページの役割の違いを明らかにします。
- [Wiki: 主張と証拠の読み方](https://github.com/yasufumi-nakata/mind-upload/wiki/claims-and-evidence) - ラベルに記載されている「主張の強さ」の読み方を理解するのに役立ちます。
- [Wiki: U 番号ガイド](https://github.com/yasufumi-nakata/mind-upload/wiki/u-number-guide) - これは、どの未解決の質問が書誌マップに関連しているかを確認するための補助ページです。
...
<h2>次に戻る場所</h2>
<p>
論文を幅広く見たい場合は<a href="https://mind-upload.com/mind_uploading_papers.html">論文集</a>、未解決の問題との対応を見たい場合は<a href="https://mind-upload.com/research_harvest_50.html">文献マップ</a>、役割の違いから整理したい場合は<a href="https://github.com/yasufumi-nakata/mind-upload/wiki/literature-and-evidence-reading">文献・証拠の読み方</a>へ戻ってください。
</p>
