# Wiki: Omoikane BioData bridge ギャップ登録

> body-state surrogate input から consciousness reproduction claim へ飛ばないための bridge register
>
> この学習ページは GitHub Wiki 用に生成されています。公開ポータルは [mind-upload.com](https://mind-upload.com) で管理しています。

- Updated: 2026-05-03 / Role: Issue

## このページの役割
このページは、BioData latent を mind-upload 側の L2/L3 substrate に渡す場合に、どこまでを入力 proxy として扱い、どこから先を未解決の研究ギャップとして止めるかを定義します。

## 正確性に関する注記
このページは semantic thought content、subjective equivalence、consciousness reproduction、identity replacement を達成済みとは主張しません。現時点の上限は body-state-surrogate-input-only です。

## 公開ページへ戻る
- [検証](https://mind-upload.com/verification.html#human-proxy-composition-card)
- [状態継続ブリッジ](https://mind-upload.com/verification.html#state-continuity-bridge-card)
- [技術ロードマップ](https://mind-upload.com/tech_roadmap.html)

## 関連 Wiki ページ
- [Wiki: Issue #267-#280 対応監査](https://github.com/yasufumi-nakata/mind-upload/wiki/open-issues-267-280-resolution) - このページが
- [Wiki: 状態継続ブリッジ](https://github.com/yasufumi-nakata/mind-upload/wiki/state-continuity-bridge) - same-subject や same-brain の証拠を same-state と読まないための橋渡し条件を確認します。
- [Wiki: 人間プロキシ構成](https://github.com/yasufumi-nakata/mind-upload/wiki/human-proxy-composition) - 複数の生きている人間 proxy row を束ねる場合の上限と残留潜在状態を確認します。
