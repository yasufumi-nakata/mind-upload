...
> 25トピック × EEG公開データ × 助成制度の実務対応表
>
> このページは GitHub Wiki 用に生成した学習ページです。公開ポータルは [mind-upload.com](https://mind-upload.com) 側で管理しています。

- 更新日: 2026-03-06 / 位置づけ: Research-to-funding map

## このページの役割
このページは、mind-upload の 25 トピックを EEG-DATA と auto-research-funds の観点で再配置し、どこまで EEG 公開データで検証できるか、どの制度タイプにどんな書き方で出すかをまとめた長文 wiki です。

## 正確さの前提
助成制度の応募資格、締切、提出様式は更新されるため、実応募前には制度本文を必ず再確認してください。
...
## 関連 Wiki
- [Wiki: ロードマップの読み方](https://github.com/yasufumi-nakata/mind-upload/wiki/roadmap-reading-guide) - 25トピックの依存関係を先に掴みたい人向けです。
- [Wiki: EEGの基本](https://github.com/yasufumi-nakata/mind-upload/wiki/eeg-basics) - EEG の観測限界を先に押さえたい人向けです。
- [Wiki: マルチモーダル統合の基本](https://github.com/yasufumi-nakata/mind-upload/wiki/multimodal-integration-basics) - EEG 単独で足りない部分の補い方を整理します。
