...
- Same-brain functional connectomics can strengthen local structure-function links while still relying on morphology-bridged labels and leaving current synaptic state and unique dynamics unresolved.
