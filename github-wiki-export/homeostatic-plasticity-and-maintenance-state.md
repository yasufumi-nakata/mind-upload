...
## このページの役割
This page responds to the intuition that if we know the wiring diagram and cell type, most of the rest will fall into place. Against that intuition, it organizes the maintenance mechanisms that remain separate variables in primary literature: intrinsic excitability, activity-dependent transcription / chromatin state, AIS and ion-channel landscapes, firing-rate set points, sleep-dependent renormalization, myelin / oligodendrocyte coupling, thermal-state, ionic milieu / chloride homeostasis, local proteostasis / synaptic-tagging state, perisynaptic extracellular matrix / perineuronal-net state, local ATP supply and mitochondrial arrangement, synaptic-density proxies including human SV2A PET, glial metabolism, clearance / immune support, and molecular turnover. It focuses only on technology and natural science, not philosophy or legal systems.
...
<h2>12 maintenance-states to fix first</h2>
<table>
<thead>
<tr>
