...
> 理論名より先に、prediction family と benchmark layer を分ける
>
...
## このページの役割
このページは、Mind-Upload で繰り返し出てくる意識理論と意識指標を、技術と自然科学の観点だけから整理する補助ページです。どれが真理かを決めるためではなく、何が prediction family で、何が perturbation benchmark で、何が spontaneous proxy や補助解析なのかを先に分けます。

## 正確さの前提
ここで示す使い分けは、各論文がそのまま宣言している結論ではありません。2026-03 時点の一次文献が比較的強く支持することと、なお残る未確定部分から本サイトが引く運用上の整理でございます。
...
## 関連 Wiki
- [Wiki: 反事実・介入・摂動](https://github.com/yasufumi-nakata/mind-upload/wiki/counterfactual-and-perturbation-verification) - 理論マーカーを介入 benchmark へ落とす条件を整理します。
- [Wiki: 観測から推定へ](https://github.com/yasufumi-nakata/mind-upload/wiki/observation-to-estimation) - 観測適合と因果同定を混同しないためのページです。
- [Wiki: 文献と証拠ページの読み方](https://github.com/yasufumi-nakata/mind-upload/wiki/literature-and-evidence-reading) - 理論論文と一次実験論文の役割差を整理します。
...
<p>
<a href="https://mind-upload.com/tech_roadmap.html">技術ロードマップ</a> では V6 を theory competition と benchmark hierarchy の問題として読み、<a href="https://mind-upload.com/verification.html">検証基盤</a> では perturbation benchmark、OOD、long-run stability、abstention を束で確認します。つまり、このページは「どの理論が正しいか」を決めるためより、「どの種類の evidence をどの強さで扱うか」をそろえるための地図でございます。
</p>
