...
<h2>Read it in four parts first</h2>
<table>
<thead>
<tr>
<th>layer</th>
...
<h2>Why the three traditional classifications are not enough</h2>
<p>
...
<h2>Minimum things to keep separate in longitudinal evaluation</h2>
<table>
<thead>
<tr>
<th>Audit items</th>
...
<p>
To go back to uncertainty and coverage-risk, go back to <a href="https://github.com/yasufumi-nakata/mind-upload/wiki/uncertainty-confidence-and-abstention">Uncertainty, calibration, abstention</a>, go back to log design for online operations go back to <a href="https://github.com/yasufumi-nakata/mind-upload/wiki/closed-loop-latency-jitter-and-safety-stops">closed-loop, delay, jitter, safety stops</a>, go back to overall pass/fail rules <a Please use href="https://mind-upload.com/verification.html">Verification infrastructure</a>.
</p>
