...
note: "Provisional draft (updated continuously; human local-route split synced on 2026-04-02)"
...
page_highlights:
  ...
  - "M1 / M3 now also split human astrocyte-related PET by target class, tracer family, route role, and covariate ceiling, so `astrocyte PET` is not treated as one interchangeable human row."
