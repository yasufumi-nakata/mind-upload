...
<p>原典: <a href="https://github.com/compcogneuro/sims/blob/main/ch3/cats_dogs/README.md" target="_blank" rel="noopener noreferrer">https://github.com/compcogneuro/sims/blob/main/ch3/cats_dogs/README.md</a></p>
...
* `cat` のみのテストに戻り、[[[sim:Test Cycle Plot]]] タブを選択して、整定サイクルにわたる調和のプロットを表示します。
