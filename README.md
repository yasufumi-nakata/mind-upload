...
- `scripts/verify_github_wiki_toolchain.sh` は、boundary check、noise cleanup、export、export validate をまとめて実行します。`VERIFY_GITHUB_WIKI_BUILD=1` を付けると Jekyll build まで含めて確認できます。
