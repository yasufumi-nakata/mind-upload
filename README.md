...
- `scripts/selftest_github_wiki_export.sh` は、isolated な source/export を `ignore/` 配下に作り、export validator が missing page、noise file、unsafe link、sidebar 漏れ、generated asset 漏れを検出できることを確認します。
