...
page_highlights:
  ...
  - "For spectroscopy-derived human maintenance routes, the budget now separates five-metabolite 1H-MRSI similarity scaffolds, 31P metabolite / pH balance, 31P MT exchange-flux, 31P NAD-content / functional routes, deuterium metabolite-mapping / absolute-quantification routes, and deuterium kinetic-rate imaging, because they constrain different inferential objects and carry different cohort, hardware, and model burdens."
...
known_points:
  ...
  - "A spectroscopy label without quantity-type disclosure remains too coarse; 1H-MRSI similarity, 31P metabolite / pH balance, 31P MT exchange-flux, 31P NAD-content / functional routes, deuterium metabolite-mapping / absolute-quantification routes, and deuterium kinetic-rate imaging are not interchangeable proxy classes."
