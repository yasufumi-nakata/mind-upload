...
page_highlights:
  ...
  - "For intrinsic-excitability / homeostatic-set-point claims, the maintenance-state budget now requires a route card that names claim family, physiological locus, direct observable, time axis / intervention window, human proxy class, and abstention."
